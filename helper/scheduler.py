...
def runScheduler():
    ...
    scheduler.add_job(runProxyFetch, 'interval', minutes=0.5, id="proxy_fetch", name="proxy采集")
    scheduler.add_job(runProxyCheck, 'interval', minutes=0.5, id="proxy_check", name="proxy检查")
